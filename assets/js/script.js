...
var loadTasks = function () {
  ...
  for (var i = 0; i < tasks.length; i++) {
    ...
    if ((tasks[i].status = "to do")) {
      ...
      listItemEl.querySelector("select[name='status-change']").selectIndex = [
        1,
      ];
      tasksInProgressEl.appendChild(listItemEm);
    } else if ((tasks[i].status = "complete")) {
      listeItemEl.querySelector("select[name='status-change']").selectIndex = [
        2,
      ];
